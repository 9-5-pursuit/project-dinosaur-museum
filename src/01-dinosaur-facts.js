...
function getLongestDinosaur(dinosaurs) {
  ...
  let nameOfLongest = dinosaurs[0].name
  let longestDinoObj = {}
  for (let i = 1; i < dinosaurs.length; i++) {
    if (longest < dinosaurs[i].lengthInMeters) {
      longest = dinosaurs[i].lengthInMeters
      nameOfLongest = dinosaurs[i].name
    }
  }
  let longestInFeet = Number((longest * 3.281).toFixed(2))
  longestDinoObj[nameOfLongest] = longestInFeet
...
function getDinosaursAliveMya(dinosaurs, mya, key) {
  ...
  for (let i = 0; i < dinosaurs.length; i++) {
    if (Object.keys(dinosaurs[i])[1] === key) {
      if (dinosaurs[i].mya.length > 1) {
    ...
    } else if (Object.keys(dinosaurs[i])[1] !== key) {
      if (dinosaurs[i].mya.length > 1) {
        if (dinosaurs[i].mya[0] >= mya && dinosaurs[i].mya[1] <= mya) {
